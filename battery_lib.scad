...
include<battery_lib/button_batteries.scad>
include<battery_lib/rectangle_batteries.scad>
include<battery_lib/tube_batteries.scad>
...
BatteryLib_Battery_Parameters = concat(BatteryLib_Tube_Battery_Parameters, BatteryLib_Rectangle_Battery_Parameters,
...
function BatteryLib_BatteryNameIsValid(battery_name) =
    let(battery_name_index = search([battery_name], BatteryLib_Battery_Parameters)[0]) battery_name_index != [];
...
function BatteryLib_Type(battery_name) = let(battery_type = _BatteryLib_RetrieveParameter(battery_name, "type"))
...
// returned
function BatteryLib_BodyDiameter(battery_name) = BatteryLib_Type(battery_name) == "tube" ||
                                                         BatteryLib_Type(battery_name) == "button"
                                                     ? _BatteryLib_RetrieveParameter(battery_name, "diameter")
                                                     : max(BatteryLib_BodyWidth(battery_name),
...
function BatteryLib_TotalDiameter(battery_name) = BatteryLib_BodyDiameter(battery_name);

// Retrieve the width of a specified battery
function BatteryLib_BodyWidth(battery_name) = BatteryLib_Type(battery_name) == "tube" ||
                                                      BatteryLib_Type(battery_name) == "button"
                                                  ? _BatteryLib_RetrieveParameter(battery_name, "diameter")
...
function BatteryLib_TotalWidth(battery_name) = BatteryLib_BodyWidth(battery_name);

// Retrieve the length (in the y dimension) of a specified battery
function BatteryLib_BodyLength(battery_name) = BatteryLib_Type(battery_name) == "tube" ||
                                                       BatteryLib_Type(battery_name) == "button"
                                                   ? _BatteryLib_RetrieveParameter(battery_name, "diameter")
...
function BatteryLib_TotalLength(battery_name) = BatteryLib_BodyLength(battery_name);

// Retrieve the body height (in the z dimension) of a specified battery
function BatteryLib_BodyHeight(battery_name) = _BatteryLib_RetrieveParameter(battery_name, "height");

// Retrieve the total height of a specified battery (including the anode and
// cathode)
function BatteryLib_TotalHeight(battery_name) = BatteryLib_Type(battery_name) == "tube"
                                                ...
                                                : BatteryLib_Type(battery_name) == "rectangle"
                                                    ? BatteryLib_BodyHeight(battery_name) +
                                                          max(BatteryLib_AnodeHeight(battery_name),
                                                              BatteryLib_CathodeHeight(battery_name))
                                                    : BatteryLib_BodyHeight(battery_name);

// Retrieve the diameter of the cathode of a specified battery
function BatteryLib_CathodeDiameter(battery_name) = BatteryLib_Type(battery_name) == "tube" ||
                                                            BatteryLib_Type(battery_name) == "rectangle"
                                                        ? _BatteryLib_RetrieveParameter(battery_name,
                                                                                        "cathode diameter")
                                                        : _BatteryLib_RetrieveParameter(battery_name, "diameter");

// Retrieve the height of the cathode of a specified battery
function BatteryLib_CathodeHeight(battery_name) = BatteryLib_Type(battery_name) == "tube" ||
                                                          BatteryLib_Type(battery_name) == "rectangle"
                                                      ? _BatteryLib_RetrieveParameter(battery_name, "cathode height")
                                                      : 0;

// Retrieve the diameter of the anode of a specified battery
function BatteryLib_AnodeDiameter(battery_name) = BatteryLib_Type(battery_name) == "tube" ||
                                                          BatteryLib_Type(battery_name) == "rectangle"
                                                      ? _BatteryLib_RetrieveParameter(battery_name, "anode diameter")
                                                      : _BatteryLib_RetrieveParameter(battery_name, "diameter");

// Retrieve the height of the anode of a specified battery
function BatteryLib_AnodeHeight(battery_name) = BatteryLib_Type(battery_name) == "tube" ||
                                                        BatteryLib_Type(battery_name) == "rectangle"
...
// alternative
function BatteryLib_TerminalDistance(battery_name) = BatteryLib_Type(battery_name) == "rectangle"
                                                         ? _BatteryLib_RetrieveParameter(battery_name,
                                                                                         "terminal distance")
                                                         : BatteryLib_BodyHeight(battery_name);
...
function _BatteryLib_RetrieveParameter(battery_name, key) = let(
    ...
    parameter_index = search([key], battery_specific_table)[0], parameter = battery_specific_table[parameter_index][1])
